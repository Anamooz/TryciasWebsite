...
export const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .catch(() => alert("Oops! Somethign went wrong. Please try again."));
  };
      ...
      <RevealOnScroll>
        <div className="px-4 w-150">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-pink-300 hover:bg-pink-400 text-white font-medium py-3 px-6 rounded transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]"
            >
              Send Message
            </button>
          </form>
